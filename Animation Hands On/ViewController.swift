...
//    var totalNumber : Int = 0
    ...
    var butirAwalPosition: CGPoint!
    var butirAkhirPosition: CGPoint!
...
//        }
    ...
    func butirLainMoved(butirAwal: UIImageView, butirAkhir: UIImageView) {
        butirAwal.center = p0
        butirAwalPosition = p0
        
        butirAkhirPosition = p3
        let distanceX = p3.x - butirAwalPosition.x
        // get the value between 0 & 1. 0 represents and po and 1 represent p2.
        var distanceXInRange = distanceX / (p2.x - p0.x)
        distanceXInRange = distanceXInRange > 0 ? distanceXInRange : -distanceXInRange
        ...
        // set the newLocation of the butir1
        butirAwal.center = CGPoint(x: CGFloat(newX), y: CGFloat(newY))
